...
# blocklists << ['https://raw.githubusercontent.com/specter78/adblock/main/ublock/adguard_url_tracking.txt']
...
readme << "| Domain | Rules |"
readme << "|:----:|:-----:|"
$domain_rules.delete_if {|k,v| v < 100 }.to_a.sort_by{ |x| x[1] }.reverse.each{ |x| readme << "| #{x[0]} | #{x[1]} |" }
readme << "\n\nTLD Counter\n\n"
readme << "| TLD | Rules |"
readme << "|:----:|:-----:|"
